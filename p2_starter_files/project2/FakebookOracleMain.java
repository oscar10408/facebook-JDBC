...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "haochuns"; // replace with your uniqname
    private static String password = "###oscar1913###"; // replace with your Oracle password (default: eecsclass)
    ...
    private static Connection getConnection() throws SQLException {
        ...
        return DriverManager.getConnection("jdbc:oracle:thin:@forktail.dsc.umich.edu:1521:COURSEDB", username,
                password);
    }
}
